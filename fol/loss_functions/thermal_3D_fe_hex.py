...
class ThermalLoss3D(FiniteElementLoss):
    ...
    def ComputeElementJacobianIndices(self,nodes_ids:jnp.array):
        indices_dof = jnp.hstack((jnp.linspace(nodes_ids[0],nodes_ids[0],1,dtype='int32'),
                                  jnp.linspace(nodes_ids[1],nodes_ids[1],1,dtype='int32'),
                                  jnp.linspace(nodes_ids[2],nodes_ids[2],1,dtype='int32'),
                                  jnp.linspace(nodes_ids[3],nodes_ids[3],1,dtype='int32'),
                                  jnp.linspace(nodes_ids[4],nodes_ids[4],1,dtype='int32'),
                                  jnp.linspace(nodes_ids[5],nodes_ids[5],1,dtype='int32'),
                                  jnp.linspace(nodes_ids[6],nodes_ids[6],1,dtype='int32'),
                                  jnp.linspace(nodes_ids[7],nodes_ids[7],1,dtype='int32'))) #indices represented the dofs of this quad
