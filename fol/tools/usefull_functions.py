...
def create_random_fourier_samples(fourier_control,numberof_sample,random_seed_key=None):
...
def create_random_voronoi_samples(voronoi_control,number_of_sample,dim=2,random_seed_key=None):
    if random_seed_key is not None:
        np.random.seed(random_seed_key)
