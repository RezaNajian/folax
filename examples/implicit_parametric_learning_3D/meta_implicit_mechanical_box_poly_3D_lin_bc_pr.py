...
def main(ifol_num_epochs=10,clean_dir=False):
    ...
    voronoi_settings = {"number_of_seeds": 25, "E_values": [0.02,1]}
    voronoi_control = VoronoiControl3D("voronoi_control", voronoi_settings, fe_mesh)
    voronoi_control.Initialize()

    coeffs_matrix, K_matrix = create_random_voronoi_samples(voronoi_control,number_of_samples=1,dim=3,random_key=42)
    ...
    for eval_id in list(test_index):
