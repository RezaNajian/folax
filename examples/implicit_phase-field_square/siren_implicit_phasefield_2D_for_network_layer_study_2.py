...
for l, (omega, alpha) in enumerate(zip(neuron_list,layer_list)):
    ...
    working_directory_name = 'siren_implicit_AllenCahn_2D_network_layer2'+'_'+str(omega)+'_'+str(alpha)
...
plot_relative_l2_error_multiple(time_plot,relative_l2_error_list,label_name=plot_label,file_name="iFOL_FEM_relative_L2_error_layer_study_all2.png")
np.savetxt("relative_l2_error_layer_study2.txt",np.hstack((time_plot.reshape(-1,1),relative_l2_error_list.T)))