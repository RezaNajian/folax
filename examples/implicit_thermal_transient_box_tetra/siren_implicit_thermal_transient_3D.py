...
import jax
from fol.loss_functions.thermal_transient_3D_fe_tetra import ThermalTransientLoss3DTetra
...
mesh_res_rate = 1
num_steps = 10
fe_mesh = Mesh("fol_io","cube_tetra_bc.med",'../meshes/')
fe_mesh_pred = Mesh("fol_io","cube_tetra_bc.med",'../meshes/')

# create fe-based loss function
bc_dict = {"T":{"left":model_settings["T_left"],"right":model_settings["T_right"]}}#
Dirichlet_BCs = True
material_dict = {"rho":1.0,"cp":1.0,"dt":0.05}
thermal_loss_3d = ThermalTransientLoss3DTetra("thermal_loss_3d",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":1,
                                                                            "material_dict":material_dict},
                                                                            fe_mesh=fe_mesh)
thermal_loss_3d_pred = ThermalTransientLoss3DTetra("thermal_loss_3d_pred",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":1,
                                                                            "material_dict":material_dict},
...
if create_random_coefficients:
    ...
    coeffs_matrix = np.full((1,fe_mesh_pred.GetNumberOfNodes()),0.0)
