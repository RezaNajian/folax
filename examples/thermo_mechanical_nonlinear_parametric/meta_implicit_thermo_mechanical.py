...
FE_TUV = np.array(nonlinear_fe_solver.SolveMulti(K_matrix[test_start_id:test_end_id,:].flatten()
...
FOL_heat_flux_at_nodes = GetHeatFluxVector2D(thermomech_loss_2d,fe_mesh,K_matrix[test_start_id:test_end_id,:].flatten(),FOL_T.flatten())
FE_heat_flux_at_nodes = GetHeatFluxVector2D(thermomech_loss_2d,fe_mesh,K_matrix[test_start_id:test_end_id,:].flatten(),FE_T.flatten())
...
plot_mesh_vec_data_thermal_clear(1,[K_matrix[test_start_id:test_end_id,:].flatten(),FOL_heat_flux_at_nodes[:,0],FOL_heat_flux_at_nodes[:,1]],
...
plot_mesh_vec_data_thermal_clear(1,[K_matrix[test_start_id:test_end_id,:].flatten(),FE_heat_flux_at_nodes[:,0],FE_heat_flux_at_nodes[:,1]],
                   ["Heterogeneity","X-heat flux","Y-heat flux"],
                   fig_title="FE heat flux",cmap = "inferno",
                   file_name=os.path.join(case_dir,"heat_flux_FE.png"))
plot_mesh_vec_data_thermal_clear(1,[K_matrix[test_start_id:test_end_id,:].flatten(),heat_flux_absolute_error[:,0],heat_flux_absolute_error[:,1]],
                   ["Heterogeneity","X-heat flux","Y-heat flux"],
