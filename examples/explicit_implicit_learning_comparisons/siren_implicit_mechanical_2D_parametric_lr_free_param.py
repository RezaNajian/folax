...
working_directory_name = 'siren_implicit_mechanical_2D_parametric_lr_free_param'
...
siren_NN = Siren(4,2,[200,200,200])
...
fol.Train(train_set=(K_matrix[eval_id:eval_id+11,:],),batch_size=200,
