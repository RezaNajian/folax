...
working_directory_name = 'siren_implicit_mechanical_2D_pr_lr'
...
if create_random_coefficients:
    ...
    with open(f'fourier_control_dict_N_{21}.pkl', 'rb') as f:
...
fol.Train(train_set=(coeffs_matrix,),batch_size=201,
            convergence_settings={"num_epochs":1000,"relative_error":1e-100,
...
for test in range(10):
    eval_id = np.random.randint(0, 201)
    ...
    plot_mesh_vec_data(1,[FOL_UV[0::2],FOL_UV[1::2],absolute_error[0::2],absolute_error[1::2]],
                    ...
                    file_name=os.path.join(case_dir,f"FOL-UV-dist_{test}.png"))
    plot_mesh_vec_data(1,[K_matrix[eval_id,:],FE_UV[0::2],FE_UV[1::2]],
                    ["K","U","V"],
                    fig_title="conductivity and FEM solution",
                    file_name=os.path.join(case_dir,f"FEM-KUV-dist_{test}.png"))
