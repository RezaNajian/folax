...
import optax
import numpy as np
from fol.loss_functions.thermal_transient_3D_fe_hex import ThermalTransientLoss3DHex
...
working_directory_name = 'meta_learning_thermal_transient_box_N41'
...
thermal_loss_3d = ThermalTransientLoss3DHex("thermal_transient_loss_3d",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":2,
...
if create_random_coefficients:
    ...
    coeffs_matrix = np.load("../training_data/3d_fft_N41_num5000.npy").reshape(5000,model_settings["N"]**3)
...
for test in range(eval_start_id,eval_end_id):
    ...
    #                 fig_title="implicit FOL solution and error",cmap = "jet",
    #                 file_name=os.path.join(case_dir,f"FOL-T-dist_test_{eval_id}.png"))
    # plot_mesh_vec_data(1,[coeffs_matrix[eval_id],FOL_T[:,0],FOL_T[:,1],FOL_T[:,-1]],
    #             ["","","",""],
    #             fig_title="",cmap = "jet",
    #             file_name=os.path.join(case_dir,f"FOL-dist_test_{eval_id}.png"))
    
    # plot_mesh_vec_data(1,[coeffs_matrix[eval_id],FE_T[:,0],FE_T[:,1],FE_T[:,-1]],
    #             ["","","",""],
    #             fig_title="",cmap = "jet",
    #             file_name=os.path.join(case_dir,f"FE-dist_test_{eval_id}.png"))
    # plot_mesh_vec_data(1,[coeffs_matrix[eval_id],absolute_error[:,0],absolute_error[:,1],absolute_error[:,-1]],
    #             ["","","",""],
    #             fig_title="",cmap = "jet",
