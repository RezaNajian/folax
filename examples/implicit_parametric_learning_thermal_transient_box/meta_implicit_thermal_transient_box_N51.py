...
working_directory_name = 'meta_learning_thermal_transient_box_N51'
...
if create_random_coefficients:
    ...
    coeffs_matrix = np.load("../training_data/3d_fft_N51_num5000.npy").reshape(5000,model_settings["N"]**3)
