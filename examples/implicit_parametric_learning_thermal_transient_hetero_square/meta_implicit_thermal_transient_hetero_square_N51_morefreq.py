...
working_directory_name = 'siren_implicit_thermal_2D_dt_0005_N51_morefreq'
...
if create_random_coefficients:
    def generate_random_smooth_patterns(L, N, num_samples=10000, smoothness_levels=[0.025,0.05,0.1,0.125,0.15,0.2,0.25,0.3,0.35,0.4]):
        """
