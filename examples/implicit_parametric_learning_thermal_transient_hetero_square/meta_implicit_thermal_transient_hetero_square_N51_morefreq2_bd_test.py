...
working_directory_name = 'siren_implicit_thermal_2D_dt_0005_N51_morefreq2_bd'
...
if create_random_coefficients:
    def generate_random_smooth_patterns(L, N, num_samples=90, smoothness_levels=[0.025, 0.05, 0.1, 0.2, 0.3, 0.4]):
        """
...
plot_mesh_vec_data_thermal(1,[coeffs_matrix[eval_id],FOL_T[:,time_list[0]],FOL_T[:,time_list[1]],FOL_T[:,time_list[2]]],
                   ...
                   file_name=os.path.join(case_dir,"SR2_FOL-T-dist.png"))
...
plot_mesh_vec_data_thermal(1,[coeffs_matrix[eval_id],FE_T[:,time_list[0]],FE_T[:,time_list[1]],FE_T[:,time_list[2]]],
                   ...
                   file_name=os.path.join(case_dir,"SR2_FEM-T-dist.png"))
...
plot_mesh_vec_data(1,[absolute_error[:,time_list2[0]],absolute_error[:,time_list2[1]],absolute_error[:,time_list2[2]],absolute_error[:,time_list2[3]]],
                   ["","","",""],
                   fig_title="Initial condition and iFOL error against FEM",cmap = "jet",
                   file_name=os.path.join(case_dir,"SR2_FOL-T-Error-dist_initial_steps.png"))
