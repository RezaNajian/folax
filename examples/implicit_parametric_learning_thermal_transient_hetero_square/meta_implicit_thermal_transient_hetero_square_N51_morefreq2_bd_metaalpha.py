...
from fol.deep_neural_networks.meta_alpha_meta_implicit_parametric_operator_learning_bd import MetaAlphaMetaImplicitParametricOperatorLearning
...
working_directory_name = 'siren_implicit_thermal_2D_dt_0005_N51_morefreq2_bd_metaalpha'
...
if create_random_coefficients:
    ...
    coeffs_matrix = np.load("siren_implicit_thermal_2D_dt_0005_N51_morefreq2_bd_final/coeffs_matrix.npy")
    hetero_info = np.load("siren_implicit_thermal_2D_dt_0005_N51_morefreq2_bd_final/hetero_info.npy")
