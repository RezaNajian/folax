...
working_directory_name = 'meta_learning_phasefield_meta_alpha3'
...
# create fol
fol = MetaAlphaMetaImplicitParametricOperatorLearning(name="meta_implicit_ol",control=no_control,
