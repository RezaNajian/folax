...
working_directory_name = 'meta_learning_phasefield_Neumann4'
...
if create_random_coefficients:
    def generate_random_smooth_patterns(L, N, num_samples=20000, smoothness_levels=[0.05, 0.1, 0.2, 0.3, 0.4]):
        """
