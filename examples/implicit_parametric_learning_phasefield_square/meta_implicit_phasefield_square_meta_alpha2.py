...
working_directory_name = 'meta_learning_phasefield_meta_alpha2'
...
# main_loop_transform = optax.adam(learning_rate_scheduler)
main_loop_transform = optax.chain(optax.adam(learning_rate_scheduler))
latent_step_optimizer = optax.chain(optax.adam(1e-3))
#main_loop_transform = optax.chain(optax.normalize_by_update_norm(),optax.adam(learning_rate_scheduler))

# create fol
fol = MetaAlphaMetaImplicitParametricOperatorLearningV2(name="meta_implicit_ol",control=no_control,
