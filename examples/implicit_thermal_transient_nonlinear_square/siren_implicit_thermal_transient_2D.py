...
thermal_loss_2d = ThermalTransientLossNonlinear2DQuad("thermal_loss_2d",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            ...
                                                                            fe_mesh=fe_mesh)
thermal_loss_2d_pred = ThermalTransientLossNonlinear2DQuad("thermal_loss_2d_pred",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":2,
                                                                            "material_dict":material_dict},
...
linear_fe_solver = FiniteElementNonLinearResidualBasedSolver("linear_fe_solver",thermal_loss_2d_pred,fe_setting)
