...
def main(ifol_num_epochs=10,solve_FE=False,clean_dir=False):
   ...
   # fe_mesh = create_quad_with_holes_tri_mesh(
    ...
    print(mechanical_loss_2d.dirichlet_indices_dict)
    
     # dirichlet control
    dirichlet_control_settings = {}
    dirichlet_control = DirichletControl2D(control_name='dirichlet_control',control_settings=dirichlet_control_settings, 
                                         fe_mesh= fe_mesh,fe_loss=mechanical_loss_2d)
    ...
    for eval_id in range(5):
        ...
        mechanical_loss_2d_updated = NeoHookeMechanicalLoss2DTri("mechanical_loss_2d",loss_settings=updated_loss_setting,
                                                                                    fe_mesh=fe_mesh)
        mechanical_loss_2d_updated.Initialize()
        try:
