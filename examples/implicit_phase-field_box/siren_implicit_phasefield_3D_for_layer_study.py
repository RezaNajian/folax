...
neuron_list = [64,64,64,64,64,64,128]
layer_list =  [1,  2, 3, 4, 5, 6,  2]
plot_label = []
...
plot_relative_l2_error_multiple(time_plot,relative_l2_error_list,label_name=plot_label,file_name="iFOL_FEM_relative_L2_error_all_layer_study.png")
