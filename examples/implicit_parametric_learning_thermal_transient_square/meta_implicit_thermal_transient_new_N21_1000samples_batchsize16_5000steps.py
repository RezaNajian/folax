...
working_directory_name = 'meta_learning_thermal_transient_new_N21_1000samples_batchsize16_5000steps'
...
if create_random_coefficients:
    def generate_random_smooth_patterns(L, N, num_samples=2500):
