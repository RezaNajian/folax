...
working_directory_name = 'meta_learning_thermal_transient_new_N51_1000samples_batchsize8_10000steps_h30'
...
if create_random_coefficients:
    ...
    coeffs_matrix = generate_random_smooth_patterns(model_settings["L"],model_settings["N"]*mesh_res_rate, num_samples=1)
else:
...
fol = MetaImplicitParametricOperatorLearning(name="meta_implicit_ol",control=no_control,
                                            loss_function=thermal_loss_2d_pred,
