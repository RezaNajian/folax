...
working_directory_name = 'meta_learning_thermal_transient_2D_all_to_all_1000samples_deep'
...
hidden_layers = [51,51,51,51,51,51]
...
main_loop_transform = optax.chain(optax.normalize_by_update_norm(),optax.adam(1e-4))
...
fol.Train(train_set=(coeffs_matrix[train_start_id:train_end_id,:],),batch_size=10,
