...
working_directory_name = 'meta_learning_thermal_transient_new_N21_2000samples_batchsize32_5000steps'
...
if create_random_coefficients:
    def generate_random_smooth_patterns(L, N, num_samples=8500):
...
fol.Train(train_set=(coeffs_matrix[train_start_id:train_end_id,:],),
          ...
          test_settings={"test_frequency":10},batch_size=32,
