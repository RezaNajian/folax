...
working_directory_name = 'meta_learning_thermal_transient_2D_one_modulator_per_synthesizer_layer_FiLM12'
...
hidden_layers = [model_settings["N"]*4]*6
...
modulator_nn = MLP(name="modulator_nn",
                   input_size=21)# Can play around with this latent size (maybe 64-128)
...
main_loop_transform = optax.chain(optax.adam(6e-6))
latent_loop_transform = optax.chain(optax.adam(6e-5))
...
fol.Train(train_set=(coeffs_matrix[train_start_id:train_end_id,:],),batch_size=4,
