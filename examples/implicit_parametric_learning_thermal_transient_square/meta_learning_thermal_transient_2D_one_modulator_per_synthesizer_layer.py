...
working_directory_name = 'meta_learning_thermal_transient_2D_one_modulator_per_synthesizer_layer'
...
modulator_nn = MLP(name="modulator_nn",
                   input_size=51, # Can play around with this latent size (maybe 64-128)
