...
working_directory_name = 'meta_learning_thermal_transient_2D_one_modulator_per_synthesizer_layer_FiLM8'
...
fol.Train(train_set=(coeffs_matrix[train_start_id:train_end_id,:],),batch_size=2,
