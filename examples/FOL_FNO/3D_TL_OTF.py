...
def main(
    ...
    for sample_id in run_list:
        ...
        # Plotter3D uses standard prefixes; each folder contains one sample.
        ...
        if solve_FE:
            ...
            plotter3d = Plotter3D(
                ...
                config={
                    "clip": False,
                    "output_image": f"plot_results_3d_sample_{sample_id}_tl_otf.png",
                },
            )
            plotter3d.render_all_panels()
        else:
            print("[PHASE_3_TL_OTF_3D] Skipping Plotter3D because solve_FE=False.")
...
if __name__ == "__main__":
    ...
    out_root = str(script_dir / "PHASE_3_TL_OTF_3D_Fourier_warmstart")
