...
import optax
import numpy as np
from fol.loss_functions.thermal_transient_hetero import ThermalTransientLoss3DHexa
...
working_directory_name = 'meta_learning_thermal_transient_box_hetero_N16_2'
...
thermal_loss_3d = ThermalTransientLoss3DHexa("thermal_transient_loss_3d",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":2,
...
if create_random_coefficients:
    ...
    coeffs_matrix = np.load("../training_data/3d_fft_N16_num5000_multiple_freq.npy").reshape(5000,model_settings["N"]**3)
...
num_epochs = 1000
learning_rate_scheduler = optax.linear_schedule(init_value=1e-5, end_value=1e-7, transition_steps=num_epochs)
