...
import jax
from fol.loss_functions.phasefield_3D_fe_tetra import AllenCahnLoss3DTetra
...
phasefield_loss_3d = AllenCahnLoss3DTetra("phasefield_loss_3d",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            ...
                                                                            fe_mesh=fe_mesh)
phasefield_loss_3d_pred = AllenCahnLoss3DTetra("phasefield_loss_3d_pred",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":4,
...
fol.Train(train_set=(jnp.concatenate((jnp.array([t_current]),FOL_T_temp)).reshape(-1,1).T,),batch_size=100,
            convergence_settings={"num_epochs":500,"relative_error":5e-5},
