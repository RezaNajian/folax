...
def main(ifol_num_epochs=10,clean_dir=False):
    ...
    working_directory_name = 'meta_implicit_mechanical_3D_schwarz'
    ...
    material_dict = {"young_modulus":1,"poisson_ratio":0.45}
    mechanical_loss_2d = NeoHookeMechanicalLoss3DTetra("mechanical_loss_2d",loss_settings={"dirichlet_bc_dict":bc_dict,
    ...
    if create_random_coefficients:
        ...
        coeffs_matrix,K_matrix = create_random_fourier_samples(fourier_control,number_of_random_samples,random_seed_key=41)
        export_dict = {}
        ...
        with open(f'fourier_control_dict_3d.pkl', 'wb') as f:
            pickle.dump(export_dict,f)
    else:
        with open(f'fourier_control_dict_3d.pkl', 'rb') as f:
