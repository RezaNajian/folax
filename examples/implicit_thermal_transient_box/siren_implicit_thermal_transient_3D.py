...
thermal_loss_3d = ThermalTransientLoss3DHex("thermal_loss_3d",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":2,
                                                                            "material_dict":material_dict},
                                                                            fe_mesh=fe_mesh)
thermal_loss_3d_pred = ThermalTransientLoss3DHex("thermal_loss_3d_pred",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":2,
                                                                            "material_dict":material_dict},
