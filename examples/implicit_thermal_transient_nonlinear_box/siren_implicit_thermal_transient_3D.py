...
import jax
from fol.loss_functions.thermal_transient_nonlinear_3D_fe_hex import ThermalTransientLossNonlinear3DHex
...
working_directory_name = 'siren_implicit_thermal_3D'
...
Dirichlet_BCs = True
material_dict = {"rho":1.0,"cp":1.0,"dt":0.05,"k0":1.0,"alpha_k":0.8}
thermal_loss_3d = ThermalTransientLossNonlinear3DHex("thermal_loss_3d",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":2,
                                                                            "material_dict":material_dict},
                                                                            fe_mesh=fe_mesh)
thermal_loss_3d_pred = ThermalTransientLossNonlinear3DHex("thermal_loss_3d_pred",loss_settings={"dirichlet_bc_dict":bc_dict,
                                                                            "num_gp":2,
                                                                            "material_dict":material_dict},
...
if create_random_coefficients:
    ...
    coeffs_matrix = np.full((1,model_settings["N"]**3),0.0)
...
fol = ImplicitParametricOperatorLearning(name="dis_fol",control=no_control,
                                        ...
                                        loss_function_pred=thermal_loss_3d_pred,
...
linear_fe_solver = FiniteElementNonLinearResidualBasedSolver("nonlinear_fe_solver",thermal_loss_3d_pred,fe_setting)
