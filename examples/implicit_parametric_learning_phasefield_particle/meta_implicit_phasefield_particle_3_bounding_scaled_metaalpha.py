...
from fol.deep_neural_networks.meta_alpha_meta_implicit_parametric_operator_learning_pf import MetaAlphaMetaImplicitParametricOperatorLearning
...
working_directory_name = 'meta_learning_phasefield_particle_3_bounding_scaled_metaalpha'
...
if create_random_coefficients:
    ...
    coeffs_matrix = np.load("meta_learning_phasefield_particle_3_bounding_scaled_final/particle_pf_2d_gaussian_N2323_num10000.npy")
