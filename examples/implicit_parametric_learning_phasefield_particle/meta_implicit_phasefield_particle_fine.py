...
working_directory_name = 'meta_learning_phasefield_particle_fine2'
...
if create_random_coefficients:
    def generate_random_smooth_patterns_from_mesh(coords, num_samples=3000,smoothness_levels=[0.15, 0.2, 0.3, 0.4, 0.5]):
        """
