...
working_directory_name = 'meta_learning_phasefield_particle_3_bounding_scaled_final'
...
if create_random_coefficients:
    ...
    pass
    # coeffs_matrix = np.load("../training_data/.npy")
    # coeffs_matrix = np.load("../training_data/particle_pf_2d_gaussian_N256_num10000.npy")
