...
working_directory_name = 'pi_fno_thermomech_2D_phy_separate_test'
...
# load teh best model
pi_fno_pr_learning.RestoreState(restore_state_directory="pi_fno_thermomech_2D_phy_sep/flax_final_state")
