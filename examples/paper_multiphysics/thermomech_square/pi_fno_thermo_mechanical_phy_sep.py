...
from fourier_neural_operator_networks import FourierNeuralOperator2DSeparate
...
working_directory_name = 'pi_fno_thermomech_2D_phy_sep'
...
fno_model = bridge.ToNNX(FourierNeuralOperator2DSeparate(modes1=12,
                                                modes2=12,
                                                width=24,
                                                depth=4,
