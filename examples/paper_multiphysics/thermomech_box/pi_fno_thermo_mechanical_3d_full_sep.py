...
working_directory_name = 'pi_fno_thermomech_3D_full_sep'
...
pi_fno_pr_learning.Train(train_set=(K_matrix[train_start_id:train_end_id,:],),
          ...
          plot_settings={"plot_list":["total_loss","phy1_loss","phy2_loss"],
                         ...
                         "save_directory":case_dir,"multiphysics":True})
# load teh best model
...
test_end_id = test_start_id + 1
FOL_TUVW = np.array(pi_fno_pr_learning.Predict(K_matrix[test_start_id:test_end_id,:])) 
...
FE_TUVW = np.array(nonlinear_fe_solver.Solve(K_matrix[test_start_id:test_end_id,:].flatten(),np.zeros((fe_mesh.GetNumberOfNodes()*4))))  #
