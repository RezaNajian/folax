...
class TestNeoHookeMechanical3D(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        test_hexa_name = 'test_mechanical_3D_hexa_poly_nonlin'
        ...
        test_tetra_name = 'test_mechanical_3D_tetra_poly_nonlin'
    ...
    def test_compute_hexahedron(self):
        ...
        mechanical_loss_3d = NeoHookeMechanicalLoss3DHexa("mechanical_hexa_loss_3d",loss_settings={"dirichlet_bc_dict":self.dirichlet_bc_dict,
                                                                                            "material_dict":{"young_modulus":1,"poisson_ratio":0.3}},
                                                                                            fe_mesh=fe_mesh)
        nonlinear_fe_solver = FiniteElementNonLinearResidualBasedSolver("nonlin_fe_solver",mechanical_loss_3d,self.fe_setting)
    ...
    def test_compute_tetra(self):
        fe_mesh = Mesh("box_io","box_3D_coarse.med",os.path.join(os.path.dirname(os.path.abspath(__file__)),"../meshes"))
        mechanical_loss_3d = NeoHookeMechanicalLoss3DTetra("mechanical_tetra_loss_3d",loss_settings={"dirichlet_bc_dict":self.dirichlet_bc_dict,
                                                                                            "material_dict":{"young_modulus":1,"poisson_ratio":0.3}},
                                                                                            fe_mesh=fe_mesh)
        nonlinear_fe_solver = FiniteElementNonLinearResidualBasedSolver("nonlin_fe_solver",mechanical_loss_3d,self.fe_setting)
