...
class TestMechanical3D(unittest.TestCase):
    ...
    def setUp(self):
        # problem setup
        test_name = 'test_mechanical_3D_hexa_poly_nonlin'
        ...
        self.mechanical_loss_3d = NeoHookeMechanicalLoss3DHexa("mechanical_loss_3d",loss_settings={"dirichlet_bc_dict":dirichlet_bc_dict,
