...
create_clean_directory('test_thermal_3D')
sys.stdout = Logger(os.path.join(case_dir,"test_thermal_3D.log"))
...
first_3D_fol = FiniteElementOperatorLearning("first_3D_fol",fourier_control,[first_3D_thermal_loss],[5,10],
                                             "swish",load_NN_params=False,NN_params_file_name="test_thermal_3D_params.npy",
                                             working_directory='test_thermal_3D')
...
first_3D_fol.Train(loss_functions_weights=[1],X_train=coeffs_matrix,batch_size=2,num_epochs=100,
                   ...
                   relative_error=1e-7,save_NN_params=True,NN_params_save_file_name="test_thermal_3D_params.npy")
...
first_3D_fol.ReTrain(loss_functions_weights=[1],X_train=coeffs_matrix,batch_size=2,num_epochs=100,
                     ...
                     NN_params_save_file_name="test_thermal_3D_params.npy")
